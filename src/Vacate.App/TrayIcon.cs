...
internal sealed class TrayIcon : IDisposable
{
    ...
    public TrayIcon(Window window)
    {
        ...
        menu.Items.Add("Открыть Vacate", null, (_, _) => Show());
        menu.Items.Add("Быстрая очистка", null, (_, _) => QuickClean());
        ...
        _icon = new Forms.NotifyIcon
        {
            Icon = _drawn,
            Visible = true,
            Text = "Vacate — очистка и обслуживание",
    ...
    private void QuickClean()
    {
        ...
        if (!File.Exists(executor))
        {
            _icon.ShowBalloonTip(5000, "Vacate",
                "Рядом с программой нет vacate-cli.exe — поставка неполная.", Forms.ToolTipIcon.Warning);
        ...
        try
        {
            ...
            _icon.ShowBalloonTip(4000, "Vacate", "Очистка запущена в фоне.", Forms.ToolTipIcon.Info);
        }
