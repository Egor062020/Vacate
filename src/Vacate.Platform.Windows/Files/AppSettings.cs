...
public sealed record AppSettings
{
    ...
    /// <summary>
    /// Знакомство при первом запуске уже показано.
    /// </summary>
    /// <remarks>
    /// Программа, здоровающаяся при каждом запуске, воспитывает привычку закрывать
    /// её окна не читая — и тогда перестают работать предупреждения, ради которых
    /// всё и затевалось.
    /// </remarks>
    public bool TourShown { get; init; }
