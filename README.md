...
**Состояние: работает.** Все основные разделы готовы, есть графический интерфейс
и консольная версия. Не сделано: подпись кода (без неё система защиты будет
предупреждать о программе каждого нового пользователя).
